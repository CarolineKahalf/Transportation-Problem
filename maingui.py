...
class GUI:
    ...
    def __init__(self):
        ...
        self.__root_window.title("Path_Finder")
    ...
    def createGui(self,pin_start_end=None,new_path=None,new_distance=None,search=None,start=None,end=None):
        ...
        ########### pins
        self.__newcanvas.create_oval(155, 240, 165, 250,fill="red") #nairobi
        self.__newcanvas.create_oval(165, 220, 175, 230,fill="red") #thika
        self.__newcanvas.create_oval(125, 210, 135, 220,fill="red") #nakuru
        self.__newcanvas.create_oval(65, 200, 75, 210,fill="red") #kisumu
        self.__newcanvas.create_oval(265, 200, 275, 210,fill="red") #Garissa
        self.__newcanvas.create_oval(265, 335, 275, 345,fill="red") #Mombasa
        self.__newcanvas.create_oval(280, 305, 290, 315,fill="red") #Malindi

            #draw the connecting lines
        if pin_start_end is not None:
            line = self.__newcanvas.create_line(pin_start_end, fill="red", width=4)
        ...
        self.__newcanvas.create_text(505,50,text="Start City: ",font=('Helvetica','10','bold'))
